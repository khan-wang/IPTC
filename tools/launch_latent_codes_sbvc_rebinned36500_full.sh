...
MANIFEST="${MANIFEST:-${REPO_ROOT}/exp_data/01_main_256_places2_rebinned36500_full/sample_manifest.csv}"
OUT_DIR="${OUT_DIR:-${REPO_ROOT}/outputs/places2_fv_reproduction/rebinned36500_full/LatentCodes_SBVC_qkv_r64_last20}"
EVAL_DIR="${EVAL_DIR:-${REPO_ROOT}/outputs/places2_fv_reproduction/rebinned36500_full/LatentCodes_SBVC_qkv_r64_last20_eval}"
REPORT_MD="${REPORT_MD:-${REPO_ROOT}/outputs/places2_fv_reproduction/rebinned36500_full/LATENT_CODES_SBVC_QKV_R64_LAST20_FULL36500_REPORT.md}"
...
env PYTHONUNBUFFERED=1 PYTHONPATH="${REPO_ROOT}/tools:${PUT_ROOT}" PUT_ROOT="${PUT_ROOT}" \
